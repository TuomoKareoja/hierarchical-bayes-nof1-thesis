...
% TODO explain why the patient standard error is not made hierarchical
...
\begin{equation*}\label{}
    \begin{aligned}\label{conjugatebayesrule}
        posterior &= \frac{P(\theta_1,\tau_1,\theta_2,\tau_2,\mu,\sigma| Y)}{P(Y)} \\
        ...
        &= P(Y_1|\theta_1,\tau_1)(Y_2|\theta_2, \tau_2)P(\theta_1,\tau_1, \mu,\sigma)P(\theta_2,\tau_2,\mu,\sigma) \nonumber \\
