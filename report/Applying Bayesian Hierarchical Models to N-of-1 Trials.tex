...
for an non-informative prior. The set prior values can be seen in table\ \ref{singlelpatientmodelpriorvalues}.
...
calculation steps often just leads the model to fail outright without any results}. If we would see any patterns, like the chains
...
After going trough the steps of:
...
level parameters are multidimensional as every patient has their own
