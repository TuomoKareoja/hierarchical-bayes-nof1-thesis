...
\(P(\mu|Y) \propto P(Y|\mu, \sigma^2)P(\mu) \). If we look at this more
...
\begin{def}\label{}
    \begin{equation}\label{}
        ...
        \exp{
            ...
            -
            \sum_{Y}
            \frac{y_t^2 - 2 \mu y + \mu^2}{2\sigma^2}
            \right \}
        }
    \end{equation}
...
\begin{def}\label{}
    \begin{equation}\label{}
        ...
        \exp{
            \left \{
            \frac{
                -\mu^2 (\sigma^2 + n\delta_0^2)
                + 2 \mu (\lambda_0 \sigma^2 + \delta_0^2 y_1 + \ldots + \delta_0^2 y_t)
                - (\lambda_0^2 \sigma^2 + \delta_0^2 y_1^2 + \ldots + \delta_0^2 y_t^2)
            }
            {2\delta_0^2 \sigma^2}
            \right \}
        }
    ...
    \begin{equation}\label{}
        ...
        \exp{
            ...
            \frac{
                - \mu^2
                + 2 \mu \frac{\mu_0 \sigma^2 + \sum_{Y} \delta_0^2 y}
                {\sigma^2 + n \delta_0^2}
                - \left(
                \frac{
