...
\begin{table}[H]
    ...
    \begin{align}\label{}
        \text{population treatment A mean prior: } & \mu_{\theta} = 10 \nonumber \\
        \text{population treatment A standard deviance prior: } & \sigma_{\theta} = 1 \nonumber \\
        \text{population treatment B mean prior: } & \mu_{\eta} = 10 \nonumber \\
        \text{population treatment B standard deviance prior: } & \sigma_{\eta} = 1 \nonumber \\
        \text{population trend mean prior: } & \mu_{\beta} = 0.1 \nonumber \\
        \text{population trend standard deviance prior: } & \sigma_{\beta} = 0.3 \nonumber \\
        \text{population measurement error scale prior: } & \gamma_{\tau} = 1 \nonumber
    \end{align}
\end{table}
...
% TODO add comparison plot for the posterior estimates for patient 1 for the 2 models
