...
% TODO add illustration with two parameters
...
current ``industry standard'' is an an algorithm called no-u-turn-Sampler\ \cite{nuts}
...
technicalities how this actually works are not for the faint of heart.
