...
data as dataframe is not necessary, but is very convenient.
...
be implemented as simple normal distribution. We solve this problem by instead using a
...
and the gamma distribution is used for variance in all cases.
...
\subsubsection{Checking the Posteriors and Doing a Reality Check on Model Fit}
\begin{pyverbatim}
