...
% TODO use a model with a trend as we don't have the space to create
% another model where we add that in. Justify by the fact that we clearly
% see a trend in the timeseries plots
...
% TODO add explanation of the beta term
