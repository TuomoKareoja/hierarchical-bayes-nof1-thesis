...
% TODO explain that how we use te prior means for multiple observations
...
% TODO add effective sample size explanations
% TODO check that explanation matches the one in the bayes problems chapter

The two metrics displayed in the table are effective sample size metrics (\pyv{ess_*})
...
differently the metric has multiple variants. \pyv{ess_bulk} tries to be a general
diagnostic estimating the effectiveness of the sampling in general\
\cite{essbulk}, while \pyv{ess_mean} is for the estimation of the mean and
...
% TODO why is treatment A and B HPD rounded?
% TODO add the real parameter values for the parameters
...
% TODO add more digits to treatment effects HPD
% TODO use 95 % HPD
