...
% TODO add in the prior parameter values
\begin{equation*}\label{}
    \begin{aligned}\label{conjugatebayesrule}
        &P(\theta_1,\tau_1,\theta_2,\tau_2,\mu,\sigma, \mu_{\mu}, \sigma_{\mu}, \gamma_{\tau}| Y) \\
        &= \frac{P(Y | \theta_1,\tau_1,\theta_2,\tau_2,\mu,\sigma, \mu_{\mu}, \sigma_{\mu}, \gamma_{\tau})P(\theta_1,\tau_1,\theta_2,\tau_2,\mu,\sigma, \mu_{\mu}, \sigma_{\mu}, \gamma_{\tau})}{P(Y)} \\
        &\text{(dropping the constant term)} \\
        &\propto P(Y | \theta_1,\tau_1,\theta_2,\tau_2,\mu,\sigma, \mu_{\mu}, \sigma_{\mu}, \gamma_{\tau})P(\theta_1,\tau_1,\theta_2,\tau_2,\mu,\sigma, \mu_{\mu}, \sigma_{\mu}, \gamma_{\tau}) \\
        &\text{(using rule of independence as data Y depends only on parameters $\theta$ and $\tau$)} \\
        &= P(Y | \theta_1,\tau_1,\theta_2,\tau_2)P(\theta_1,\tau_1,\theta_2,\tau_2,\mu,\sigma, \mu_{\mu}, \sigma_{\mu}, \gamma_{\tau}) \\
        &\text{(using rule of independence to separate the two patients)} \\
        &= P(Y_1 | \theta_1,\tau_1)P(Y_2 | \theta_2,\tau_2)P(\theta_1,\tau_1,\theta_2,\tau_2,\mu,\sigma, \mu_{\mu}, \sigma_{\mu}, \gamma_{\tau}) \\
