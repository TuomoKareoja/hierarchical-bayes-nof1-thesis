...
the computated posterior distributions.
...
% TODO in this case just looking at individual posterior estimates is not enough as we
% are interested in the difference (check Kruschke for the explaining the problem)
